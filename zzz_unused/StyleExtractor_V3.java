 ...
 * ---------------------------------------------------------------------------
 * This class jumps to UIStyleSelector_zzz.java, a gui class
...
public class StyleExtractor_V3 {
        ...
        private _1_FeatureAnnotator annotator;
  ...
  public StyleExtractor_V3() {
       annotator = new _1_FeatureAnnotator();
       corpus = annotator.getCorpus();
       extract();
       Out.prln("*** STYLE EXTRACTOIN COMPLETED *** ");
  }
...
//      new UIStyleSelector_zzz(headList, bodyList);
