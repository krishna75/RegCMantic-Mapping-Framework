...
public class UIComplianceChecker extends RcmFrame {
 ...
 /**
    ...
    private void process(){
        getLblTitle().setText("Compliance Checker");
...
/**
  ...
  private void setCells(){
        table.getColumn("Result ID").setMaxWidth(100);
        table.getColumn("Remark").setMaxWidth(200);
        table.setRowHeight(40);
        table.setBackground(new java.awt.Color(0, 255, 204));
        
        // making result id column distinct.
        TableColumn colResultId  = table.getColumn("Result ID");
        colResultId.setMaxWidth(75);
        colResultId.setCellRenderer(new TextCellRenderer());
        
        // making boolean cells (columns) to display custom object (i.e. check and cross marks)
        setBooleanColumn("Complied");
        setBooleanColumn("Employees");
        setBooleanColumn("Completed");
        setBooleanColumn("Report");
        setBooleanColumn("Report Detail");
    }
/**
